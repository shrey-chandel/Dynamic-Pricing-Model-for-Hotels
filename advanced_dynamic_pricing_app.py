...
os.chdir(r'C:\Users\SHREY\Documents\Python\Price detection')


@st.cache_data
def load_and_preprocess_data():
    try:
        data = pd.read_csv('hotel_dynamic_pricing.csv')
    except FileNotFoundError:
        st.error("Error: 'hotel_dynamic_pricing.csv' not found. Please ensure it’s in the directory.")
